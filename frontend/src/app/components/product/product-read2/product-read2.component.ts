...
export class ProductRead2Component implements AfterViewInit, OnInit {
  // o angular, por meio do decorator ViewChild, percorre o template (html), pega a primeira ocorrência do componente (ex: MatPaginator) e joga sua instância para a variavel ts (ex: paginator)
