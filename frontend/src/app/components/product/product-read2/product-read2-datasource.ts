...
export class ProductRead2DataSource extends DataSource<Product> {
  ...
  // Método que pega a página atual
  private getPagedData(data: Product[]) {
    const startIndex = this.paginator.pageIndex * this.paginator.pageSize;
    // o splice é um método do js, que pega um subarray dentro de um array maior (ex: tenho 30 produtos, mas quero mostrar apenas 5)
    // o startIndex é o índice que quero começar a mostar (ex: a partir do 15)
    // o pageSize é a qauntidade elementos (ex: quero mostrar apenas 5)
  ...
  // Método que faz a ordenação de dados
